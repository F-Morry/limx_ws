...
struct ScanData {
    ...
    Eigen::Quaterniond imu_orientation; // 新增：IMU姿态 (w, x, y, z)
};
...
//     return pc2_dst;
// }
inline sensor_msgs::msg::PointCloud2 laser2cloudmsg(sensor_msgs::msg::LaserScan::ConstSharedPtr laser, std::string frame_id = "scan")
{
    static laser_geometry::LaserProjection projector;
    sensor_msgs::msg::PointCloud2 pc2_dst;
    projector.projectLaser(*laser, pc2_dst, -1, laser_geometry::channel_option::Intensity | laser_geometry::channel_option::Distance);
